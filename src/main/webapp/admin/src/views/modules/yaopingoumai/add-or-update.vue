  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yishengzhanghao" label="医生账号" prop="yishengzhanghao">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zhengzhuangmiaoshu = this.ruleForm.zhengzhuangmiaoshu.replace(reg,'../../../ssmukk17/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yaopingoumai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yaopingoumaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
