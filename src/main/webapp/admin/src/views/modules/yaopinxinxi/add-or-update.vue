    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="药品类别" prop="yaopinleibie">
          <el-select :disabled="ro.yaopinleibie" v-model="ruleForm.yaopinleibie" placeholder="请选择药品类别">
            <el-option
...
export default {
  ...
  created() {
	...
	this.ruleForm.youxiaoqizhi = this.getCurDate()
  ...
  methods: {
	...
	this.ruleForm.yaopinshuoming = this.ruleForm.yaopinshuoming.replace(reg,'../../../ssmukk17/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
